...
"""Dataset implementation for multimodal data loading in UALM training."""
...
from dataloader.multimodal_loader.audio_loader import LhotseAudioReader
from dataloader.multimodal_loader.text_loader import TextReader
from dataloader.multimodal_loader.dialogue_loader import DialogueReader
...
reader_types = {
    ...
    "tarball_audio_byteseek": TarballAudioReader,
    "tarball_dialogue": TarballDialogueReader,
}
