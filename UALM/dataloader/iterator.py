...
"""Data iterator factory for creating batch iterators in UALM training."""
...
from dataloader.batch import batchfy
from dataloader.dataset import CombinedDataset
from dataloader.task_conf import TASK_CONFIGS

T = TypeVar("T")


class DataIteratorFactory:
    """Factory for creating data iterators for UALM training.
    ...
    def __init__(
        ...
        if self.sequential_load:
            ...
            for entry in cache_registered + cache_unregistered:
                ...
                # # comment this as collate_fn will call _apply_chat_template to solve this issue
